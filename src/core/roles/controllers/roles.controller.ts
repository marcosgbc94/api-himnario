...
export class RolesController {
    ...
    @ApiResponse({ status: 409, description: 'El usuario ya tiene ese rol asignado' })
    ...
    assignRoleToUser(
      ...
      return this.rolesService.assignRole(userId, body.slug, executorId);
    }
    ...
    @ApiResponse({ status: 409, description: 'El usuario no tiene ese rol asignado' })

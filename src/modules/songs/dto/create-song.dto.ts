...
export class CreateSongDto {
  ...
  @IsOptional()
  @Length(0, 512, {
    message: 'La descripción no puede superar los 512 caracteres',
  })
  summary?: string;

  @IsUUID('4', {
    message: 'El tipo de canción debe ser un UUID válido de la tabla song_type',
  })
  ...
  @IsNotEmpty({
    message: 'La canción debe tener al menos un slide para ser creada',
  })
